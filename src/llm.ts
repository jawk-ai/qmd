...
export interface LLM {
  ...
  /**
   * The generation model name/URI, when the backend exposes one. Optional
   * because remote-only backends may not have a local generation model.
   */
  readonly generateModelName?: string;

  /**
   * The rerank model name/URI, when the backend exposes one. Optional because
   * remote-only backends may not have a local rerank model.
   */
